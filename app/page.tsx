      ...
      <div className="flex items-center justify-between px-4">
        ...
        <div className="grid grid-cols-[1fr_70px] justify-end w-full">
            <div className="flex gap-x-9 border-b border-r border-black py-1 pr-4 pl-2">
                {
                  listNav.map((value) => <button className="tracking-defaultSpacing">{value}</button>)
                }
            </div>

            <div className="grid grid-cols-2 items-center border-b border-black gap-x-2 px-2 ">
              <Image src={'/icons/cart.svg'} alt="cart icon" width={30} height={30}></Image>
              <Image src={'/icons/menu.svg'} alt="menu icon" width={15} height={15}></Image>
            </div>

            <div className="flex items-center border-r border-black py-1 pr-4 pl-2">
              <input className="border-l border-black pl-2 tracking-defaultSpacing" type="text" value={'Search. . . .'}></input>
                <div className="grow">
                  <Image src={'/icons/magnifier.svg'} alt="cart icon" width={20} height={20} className="mx-auto"></Image>
                </div>
            </div>
        </div>
      </div>
